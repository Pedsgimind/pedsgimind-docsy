...
> **Also called:** “Food stuck in the chest,” “can’t swallow,” “swallowing hurts,” “dysphagia,” “odynophagia”  
>  
...
1) **True choking (airway):** Food goes into the breathing tube and blocks airflow.  
2) **Food stuck (esophagus):** Food is stuck in the food pipe behind the chest bone.  
3) **Painful swallowing (odynophagia):** Swallowing hurts because the throat or esophagus is inflamed or irritated.

### What part of the body is involved? (small diagram required)

<!-- AI IMAGE PROMPT: Friendly, simple labeled diagram for parents showing mouth → split into airway (trachea/windpipe) vs esophagus (food pipe). Use clear labels: "Airway = breathing" and "Esophagus = food pipe." Add simple icons: lungs for airway, stomach for esophagus. Show where "food stuck" feels (mid-chest) and where "painful swallowing" may occur (throat). Not scary, soft colors. -->
![Diagram showing airway vs esophagus and where symptoms happen](/images/choking-vs-food-stuck-vs-painful-swallowing-placeholder-1.png)

### Common myths vs facts
- **Myth:** “Any swallowing problem is choking.”  
  **Fact:** True choking is an **airway** emergency. “Food stuck” is usually the **esophagus**.
- **Myth:** “If my child can talk, it’s still choking.”  
  **Fact:** If they can talk/cry/cough strongly, the airway is likely **not fully blocked**.
- **Myth:** “Food stuck is always mild.”  
...
> 1) **Can my child breathe and speak/cry?**  
> 2) **Can my child swallow saliva (not drooling/spitting)?**  
> 3) **Is it mainly pain with swallowing, rather than stuck food?**
