...
<!-- AI IMAGE PROMPT: Simple labeled abdomen diagram for parents showing stomach, small intestine, colon, appendix (right lower abdomen), bladder. Add simple pointers for common pain sources: constipation (colon), appendicitis (RLQ), urinary/bladder, stomach. Not scary, clean, friendly colors. -->
![Simple abdominal diagram with key organs and common pain areas](/images/abdominal-pain-children-placeholder-1.png)
...
<!-- AI IMAGE PROMPT: Simple child-friendly constipation algorithm infographic. Start: belly pain → check red flags → check constipation clues → home steps (fluids/fiber/toilet routine) → if not improving or red flags → clinic. Include icons for toilet, water, calendar, doctor. -->
![Constipation-friendly algorithm for belly pain](/images/abdominal-pain-constipation-algorithm-placeholder-2.png)
