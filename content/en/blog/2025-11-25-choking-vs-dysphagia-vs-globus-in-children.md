...
<!-- AI IMAGE PROMPT: Simple, friendly diagram showing mouth → throat with two pathways: airway (trachea to lungs) and esophagus (to stomach). Label: "Airway = breathing (choking emergency)" and "Esophagus = food pipe (food stuck/dysphagia)." Add a small throat area label for globus sensation. Include icons: lungs, stomach, throat. Not scary. -->
![Airway vs esophagus diagram (choking vs dysphagia vs globus)](/images/choking-dysphagia-globus-placeholder-1.png)
...
- American Academy of Pediatrics (HealthyChildren.org): choking prevention guidance  
- First aid organizations (Red Cross / St. John Ambulance): choking response  
- Children’s hospital resources on dysphagia, food impaction, and globus sensation  
- National pediatric gastroenterology society resources on eosinophilic esophagitis and dysphagia  
- Poison control guidance for battery and magnet ingestion
