...
<!-- AI IMAGE PROMPT: Friendly, simple diagram of the abdomen for parents showing stomach, small intestine, colon, and a simple "gut–brain connection" arrow from brain to gut. Label common functional pain area (around belly button) and constipation (colon). Include appendix area as a “red flag location” label. Not scary, clean and modern. -->
![Diagram: gut organs + gut–brain connection + common pain areas](/images/recurrent-abdominal-pain-functional-vs-organic-placeholder-1.png)
...
<!-- AI IMAGE PROMPT: Simple constipation + recurrent pain flowchart: Start "Recurrent belly pain" → Check red flags → If none → Check constipation clues → Start hydration/fiber/toilet routine + clinician-guided stool softener if needed → Reassess in 2–4 weeks → If not improving or red flags → clinic/testing. Clean, parent-friendly icons, not scary. -->
![Flowchart: recurrent pain + constipation-first approach](/images/recurrent-abdominal-pain-constipation-flowchart-placeholder-2.png)
...
- North American Society for Pediatric Gastroenterology, Hepatology and Nutrition resources on functional abdominal pain and constipation  
- Children’s hospital education pages on irritable bowel syndrome and functional dyspepsia in children  
- Celiac disease children’s hospital pages and screening guidance  
- Pediatric inflammatory bowel disease resources from children’s hospitals and national pediatric gastroenterology societies
