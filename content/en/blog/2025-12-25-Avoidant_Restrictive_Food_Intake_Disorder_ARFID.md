...
> ✅ **ARFID** is a feeding/eating disorder where a child avoids or restricts food enough to cause **poor growth, weight loss, nutrient deficiencies, reliance on supplements/tube feeds, or major stress/impairment**—**without** body-image goals (unlike anorexia).  
...
<!-- AI IMAGE PROMPT: Calm “ARFID triangle” diagram showing three drivers: sensory sensitivity, fear of consequences (choking/vomiting/pain), low appetite/interest. Add arrows to outcomes: weight/growth, nutrient deficiency, stress. Parent-friendly. -->
![Diagram showing ARFID drivers (sensory, fear, low appetite) and outcomes (growth, nutrients, stress)](/images/arfid-placeholder-1.png)
