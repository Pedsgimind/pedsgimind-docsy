...
> ✅ **What this is:** CBT teaches kids practical skills to change unhelpful thought patterns, body stress responses, and avoidance behaviors that can worsen gut symptoms.

---

## 1) 🧾 Quick “At-a-glance” box (top of page)

> ✅ **Tool name:** Cognitive-Behavioral Therapy (CBT)  
...
<!-- AI IMAGE PROMPT: Simple, friendly loop diagram labeled “thoughts → feelings → body signals → actions,” with a “skills” arrow breaking the loop (breathing, coping thoughts, gradual return to activity). Child-friendly icons; not scary. -->
![Simple diagram: CBT breaks the stress–pain cycle](/images/cbt-functional-abdominal-pain-placeholder-1.png)
...
> ✅ **Do this now: The 3-Step CBT Reset**
...
This guide supports—not replaces—medical care.
