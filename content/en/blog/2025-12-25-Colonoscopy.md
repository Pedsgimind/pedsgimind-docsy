...
<!-- AI IMAGE PROMPT: Simple, child-friendly diagram showing the colon and rectum, with a thin flexible scope entering through the anus and viewing the colon lining. Calm colors, no blood. -->
![Simple diagram showing colonoscopy examining the colon lining](/images/colonoscopy-placeholder-1.png)
...
## 4) 👀 What parents might notice (symptoms leading to colonoscopy)
...
> ✅ **Good bowel prep is the most important part** of a successful colonoscopy.
...
> ✅ Colonoscopy results directly shape the treatment plan.
...
## 🧾 Printable: Colonoscopy Prep Checklist
...
## 🧾 Printable: Symptom Log (Pre-Test)
Date: ______  
...
This guide supports—not replaces—medical advice. Seek urgent care for heavy bleeding, severe pain, or concerning symptoms.
