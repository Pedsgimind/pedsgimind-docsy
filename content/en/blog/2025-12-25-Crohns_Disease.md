...
<!-- AI IMAGE PROMPT: Simple, friendly diagram of digestive tract highlighting Crohn’s disease affecting mouth-to-anus with patchy areas, plus small icon for perianal disease. Not scary. -->
![Simple diagram showing Crohn’s disease can affect anywhere from mouth to anus, patchy inflammation](/images/crohns-placeholder-1.png)
...
> ✅ Treatment is individualized. The goal is **deep control of inflammation**, not just symptom masking.
...
This guide supports—not replaces—medical advice. Seek urgent care for severe pain, heavy bleeding, dehydration, persistent vomiting, or fever with severe symptoms.
