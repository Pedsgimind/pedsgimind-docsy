...
> ✅ **Condition name:** Cyclic Vomiting Syndrome (CVS)  
...
<!-- AI IMAGE PROMPT: Friendly diagram showing brain–gut connection and “migraine pathway” triggering vomiting episodes. Include a simple timeline with 4 phases: well → warning → vomiting → recovery. Not scary. -->
![Simple diagram: cyclic vomiting phases and brain–gut migraine pathway](/images/cyclic-vomiting-placeholder-1.png)
...
> ✅ CVS is all about **early action**. Treating in the warning phase can sometimes shorten or stop the episode.
...
## 🧾 Printable: One-Page Action Plan (Cyclic Vomiting Syndrome)
...
## 🧾 Printable: Episode Diary / Tracker
Episode # ____  
...
## 🧾 Printable: School/Daycare Instructions Page (CVS)
