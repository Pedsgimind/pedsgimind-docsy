...
<!-- AI IMAGE PROMPT: Friendly diagram showing food moving through stomach and intestines with “enzymes” and “absorption” icons. Show that undigested carbs reach the colon and cause gas/bloating/diarrhea. Not scary. -->
![Simple diagram: how undigested foods can cause gas, bloating, diarrhea](/images/food-intolerance-placeholder-1.png)

### Common myths vs facts
- **Myth:** “Any rash means intolerance.”  
  **Fact:** Rash suggests allergy or eczema triggers; intolerance usually causes gut symptoms.
- **Myth:** “The fix is removing many foods forever.”  
  **Fact:** Start small and structured; most kids can tolerate some amount.
- **Myth:** “Tests can tell every intolerance.”  
...
> ✅ **Do this now:**
1) Hydrate and keep meals simple if symptoms flaring.  
2) Check for constipation signs.  
3) Start a 7-day food/symptom log.  
4) Choose ONE likely trigger to trial-remove for 2–3 weeks.
...
This guide supports—not replaces—medical advice. Seek urgent care for dehydration, blood in stool, severe pain, persistent vomiting, or poor growth.
