...
<!-- AI IMAGE PROMPT: Friendly diagram showing a child imagining a warm blanket/light over the belly; arrows showing “calm brain” → “calm gut”; include simple labels; not scary. -->
![Simple diagram: guided imagery calms the gut–brain connection](/images/guided-imagery-belly-pain-placeholder-1.png)
...
## 3) 🧩 Why it happens (what imagery targets)
...
## 🧾 Printable: One-Page Action Plan (Guided Imagery)
- [ ] 10 slow breaths  
...
This guide supports—not replaces—medical advice. Seek urgent care if worried.
