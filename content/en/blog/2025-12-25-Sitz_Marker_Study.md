...
<!-- AI IMAGE PROMPT: Simple child-friendly diagram of the colon with tiny markers moving over days (Day 1 → Day 3 → Day 5), showing normal vs slow vs outlet retention. Calm, non-scary style. -->
![Simple diagram showing how markers move through the colon over several days](/images/sitz-marker-study-placeholder-1.png)
...
### 🔴 Emergency (unrelated to the test)
...
## 🧾 Printable: Sitz Marker Study Prep Checklist
