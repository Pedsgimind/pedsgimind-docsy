...
> ✅ **Test name:** Upper GI Study  
> **Common names:** Upper GI series, barium swallow (sometimes used loosely), contrast swallow, fluoroscopy Upper GI  
>
> **Plain-language summary (2–3 lines):**  
> Your child drinks a contrast liquid while X-ray images are taken in real time. The test shows the shape and position of the esophagus, stomach, and upper small intestine, helping detect problems like malrotation, narrowing, or obstruction.
>
> **Who it affects (typical ages):**  
> Newborns, infants, children, and teens—especially with vomiting or feeding issues.
>
...
<!-- AI IMAGE PROMPT: Friendly diagram showing esophagus, stomach, duodenum. Show a child drinking contrast and arrows showing contrast flow. Label “Upper GI X-ray images.” Non-scary. -->
![Simple diagram showing Upper GI study: contrast flow through esophagus, stomach, and duodenum](/images/upper-gi-study-placeholder-1.png)

### Common myths vs facts
- **Myth:** “This test diagnoses GERD.”  
  **Fact:** It may show reflux during the study, but it is **not the best test for reflux disease severity**.
- **Myth:** “The contrast is harmful.”  
  **Fact:** It is generally safe; constipation can occur afterward.
- **Myth:** “My child will be in pain.”  
  **Fact:** The test is usually painless; the hardest part is drinking the contrast and holding still.

---

## 3) 🧩 Why it happens (why the test is ordered)
...
> ✅ Prep is mostly about fasting and comfort.
...
> ✅ Upper GI results guide next steps.
...
## 🧾 Printable: Upper GI Study Checklist
Before:
