...
<!-- AI IMAGE PROMPT: Parent-friendly diagram showing digestive tract with simple labels: stomach, small intestine, colon, rectum/anus. Color code regions for bleeding appearance: anus/rectum → bright red on paper; colon → bright red mixed or maroon; upper GI → black tarry stool. Include “call ER” icon next to black stool and large bleeding. Not scary, clean design. -->
![Diagram: where bleeding may come from and how stool color can look](/images/blood-in-stool-where-it-comes-from-placeholder-1.png)
