...
<!-- AI IMAGE PROMPT: Simple child-friendly graphic showing a growth chart with two lines: “steady on curve” vs “dropping percentiles.” Add icons for main drivers: calories (plate), gut absorption (intestine), inflammation/chronic disease (thermometer), hormones (thyroid/growth hormone), genetics (family). Clean, reassuring, not scary. -->
![Diagram: what doctors look for on growth charts and common growth drivers](/images/poor-growth-growth-chart-drivers-placeholder-1.png)
...
2) **Start a 3-day food + drink diary**
...
This guide supports—not replaces—medical advice. If you are worried about your child, trust your instincts and seek medical assessment.
