...
> **Also called:** Needle acupuncture, ear acupuncture (auricular), acupressure, pressure-point therapy, wrist nausea bands  
>  
...
> These techniques may help regulate pain signals and calm the gut–brain connection in some kids.  
>  
> **Who it helps most (typical ages):**  
...
<!-- AI IMAGE PROMPT: Friendly, non-scary diagram showing a child’s hand/wrist with the P6 (Neiguan) point location marked 2–3 finger widths above the wrist crease between two tendons; include simple labels “P6 nausea point”; show gentle finger pressure; soft colors. -->
![Simple diagram: P6 wrist point for nausea (acupressure)](/images/acupuncture-acupressure-placeholder-1.png)

### Myths vs facts
- **Myth:** “Acupuncture is unsafe for kids.”  
  **Fact:** When done by a **licensed, pediatric-experienced** practitioner using sterile technique, serious complications are uncommon.
- **Myth:** “Acupressure can replace medical treatment.”  
  **Fact:** It’s a **supportive tool**—not a substitute for evaluation when symptoms are concerning.
...
> 3) Measure **2–3 finger widths** above the crease.  
> 4) Press between the two central tendons (middle of the wrist).  
> 5) Apply firm gentle pressure for **1–2 minutes**, then repeat on the other wrist.  
> 6) Repeat 2–4 times/day as needed.
...
<div style="height:4px;background:#000;margin:24px 0;"></div>
