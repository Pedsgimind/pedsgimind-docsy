(Full parent-friendly Markdown post, ready to paste into PedsGIMind)
...
<!-- AI IMAGE PROMPT: Simple child-friendly diagram showing rectum, anus, internal and external anal sphincter, with arrows showing squeeze and push. Calm, non-scary style. -->
![Simple diagram showing rectum and anal muscles tested during anorectal manometry](/images/anorectal-manometry-placeholder-1.png)
...
## 4) 👀 What parents might notice (symptoms leading to the test)
...
> ✅ Good preparation makes the test quicker and more accurate.
...
### 🔴 Emergency (unrelated to the test itself)
...
## 🧾 Printable: Anorectal Manometry Prep Checklist
...
## 🧾 Printable: Result Discussion Sheet
