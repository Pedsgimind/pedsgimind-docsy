...
> ✅ **Condition name:** Neonatal Cholestasis  
...
<!-- AI IMAGE PROMPT: Gentle, parent-friendly diagram showing liver making bile, bile ducts draining into intestine. Show cholestasis as “blocked/slow flow” leading to bile backing up and causing jaundice/dark urine. Not scary. -->
![Simple diagram showing bile flow and how cholestasis causes bile backup and jaundice](/images/neonatal-cholestasis-placeholder-1.png)
...
> ✅ Treatment depends on the cause. Early identification is key.
...
## 🧾 Printable: Neonatal Cholestasis One-Page Action Plan
...
## 🧾 Printable: Vitamin Schedule Box (if prescribed)
...
This guide supports—not replaces—medical advice. Persistent jaundice beyond 2 weeks or pale stools requires urgent evaluation.
