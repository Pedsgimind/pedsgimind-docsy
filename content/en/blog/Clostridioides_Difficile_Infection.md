...
> ✅ **Condition name:** Clostridioides difficile infection  
...
<!-- AI IMAGE PROMPT: Simple child-friendly diagram of the colon showing C. diff bacteria producing toxins that irritate the colon lining. Calm, non-scary style. -->
![Simple diagram showing C. diff toxins causing inflammation in the colon](/images/c-diff-placeholder-1.png)
...
> ✅ Treatment requires **medical guidance**. Home care supports hydration and recovery.
...
This guide supports—not replaces—medical advice. Seek urgent care for severe pain, dehydration, or bloody stools.
