(Child-friendly + parent-friendly, still full .md, ready for PedsGIMind)
...
<!-- AI IMAGE PROMPT: Child-friendly diagram of colon (large intestine) with a small camera icon looking inside. Include “asleep during test” icon. Calm, non-scary, no blood. -->
![Child-friendly colon diagram showing where colonoscopy looks](/images/colonoscopy-kids-placeholder-1.png)
...
This guide supports—not replaces—medical advice. Seek urgent care for heavy bleeding, severe pain, or dehydration.
...
• Part C: Hydrogen_Breath_Test.md
