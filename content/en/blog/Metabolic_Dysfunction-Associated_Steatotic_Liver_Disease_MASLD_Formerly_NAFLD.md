...
> ✅ **MASLD** (previously known as **non-alcoholic fatty liver disease / NAFLD**) means **fat buildup in the liver** related to **metabolic health**, not alcohol.  
...
<!-- AI IMAGE PROMPT: Friendly diagram showing a healthy liver vs fatty liver with fat droplets inside liver cells, plus icons for sugar, insulin, and activity. Non-scary. -->
![Simple diagram showing healthy liver vs fatty liver in MASLD](/images/masld-nafld-placeholder-1.png)
...
> ✅ **Lifestyle change is first-line treatment** and often very effective.
...
> ✅ There is **no single pill** that cures MASLD in children.
...
## 🧾 Printable: MASLD One-Page Action Plan
**Daily:**
...
This guide supports—not replaces—medical advice. Seek urgent care for bleeding, severe pain, or confusion.
