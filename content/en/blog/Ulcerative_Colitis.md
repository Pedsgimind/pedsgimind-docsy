(Full parent-friendly Markdown post — clean .md, no repetition, ready for PedsGIMind)
...
> ✅ **Condition name:** Ulcerative Colitis (UC)  
> **Common names:** Pediatric ulcerative colitis, IBD (UC type)  
>
> **Plain-language summary (2–3 lines):**  
> Ulcerative colitis causes chronic inflammation of the colon lining, leading to frequent stools, blood or mucus in stool, and urgency. The disease can flare and settle, but treatment aims to control inflammation, heal the bowel, and support normal growth and daily life.
>
...
<!-- AI IMAGE PROMPT: Simple, friendly diagram showing colon highlighted continuously from rectum upward to show ulcerative colitis involvement. Calm colors, non-scary. -->
![Simple diagram showing ulcerative colitis affecting the colon continuously from the rectum](/images/ulcerative-colitis-placeholder-1.png)

### Common myths vs facts
- **Myth:** “UC is caused by food or stress.”  
  **Fact:** UC is immune-mediated; food and stress can worsen symptoms but do not cause it.
- **Myth:** “UC is the same as Crohn’s disease.”  
  **Fact:** UC affects only the colon and is continuous; Crohn’s can affect any part of the gut.
- **Myth:** “Surgery always happens.”  
...
> ✅ Ulcerative colitis **always requires medical treatment**. Home care supports healing and quality of life.
...
> ✅ Treatment depends on disease severity and extent.
...
## 🧾 Printable: UC Flare Action Plan
...
## 🧾 Printable: Stool & Symptom Tracker
Date: ______  
- Stools/day: ______  
...
This guide supports—not replaces—medical advice. Seek urgent care for heavy bleeding, severe pain, dehydration, or fever with worsening symptoms.
