...
<!-- AI IMAGE PROMPT: Friendly diagram showing copper from food going to liver; normal liver sends excess copper into bile/stool, while Wilson’s shows copper buildup in liver and possible spread to brain/eyes. Non-scary, simple icons. -->
![Simple diagram showing copper buildup in Wilson’s disease (liver + possible brain/eyes)](/images/wilsons-placeholder-1.png)
...
### Brain/mood-related symptoms (can happen)
...
This guide supports—not replaces—medical advice. Seek urgent care for bleeding, confusion, severe illness, or sudden neurologic changes.
